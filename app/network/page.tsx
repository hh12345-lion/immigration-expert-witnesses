  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="text-lg font-bold text-[#1A2744]">Country Witness Sites</h2>
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
          {countrySites.map((site) => (
            <article
              key={site.url}
              className="flex min-w-0 flex-col rounded-[8px] border border-[#C5D0DC] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.08)]"
            >
              <h3 className="text-lg font-bold text-[#1A2744]">{site.name}</h3>
              <p className="mt-1 text-xs font-medium text-[#B8943E]">{site.role}</p>
              <p className="mt-3 flex-1 text-sm leading-relaxed text-[#374151]">{site.description}</p>
              <a
                href={site.url}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-flex min-h-[44px] items-center text-sm font-semibold text-[#1A6B78] hover:underline"
              >
                {site.anchorText} →
              </a>
            </article>
        ...
        <h2 className="mt-12 text-lg font-bold text-[#1A2744]">Thematic Witness Sites</h2>
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
        ...
        <h2 className="mt-12 text-lg font-bold text-[#1A2744]">Sister Hub</h2>
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
        ...
        <div className="mt-12 flex flex-wrap gap-4">
          ...
          <Link href="/expert-witness-framework" className="font-semibold text-[#1A6B78] hover:underline">
            Expert witness framework
          </Link>
          <Link href="/guides/choosing-right-expert-witness" className="font-semibold text-[#1A6B78] hover:underline">
