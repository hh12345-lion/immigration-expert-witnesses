...
export default function PrivacyPage() {
  ...
  return (
    <PageShell title="Privacy Policy" breadcrumbs={crumbs}>
      ...
      <h2 className="mt-8 text-lg font-bold text-[#18181b]">Data we collect</h2>
      ...
      <h2 className="mt-8 text-lg font-bold text-[#18181b]">How we use your data</h2>
      <p className="mt-4 text-[#3f4654] leading-relaxed">
      ...
      <h2 className="mt-8 text-lg font-bold text-[#18181b]">Data retention</h2>
      <p className="mt-4 text-[#3f4654] leading-relaxed">
      ...
      <h2 className="mt-8 text-lg font-bold text-[#18181b]">Your rights</h2>
      <p className="mt-4 text-[#3f4654] leading-relaxed">
