  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-8 text-xl font-bold text-[#1A2744]">2. Prepare the Letter of Instruction</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-8 text-xl font-bold text-[#1A2744]">3. Obtain Legal Aid Prior Authority</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-8 text-xl font-bold text-[#1A2744]">4. Submit Your Instruction</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
          Contact us via the{" "}
          <Link href="/contact" className="text-[#1A6B78] hover:underline">
            instruction form
          </Link>{" "}
        ...
        <h2 className="mt-8 text-xl font-bold text-[#1A2744]">5. Meet Exchange Deadlines</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          ...
          <Link href="/guides/instructing-immigration-expert-witness" className="font-semibold text-[#1A6B78] hover:underline">
