  ...
  return (
    <>
      ...
      >
        ...
        <h2 id="ikarian-reefer" className="mt-10 scroll-mt-24 text-xl font-bold text-[#18181b]">
        ...
        <p className="mt-4 text-[#3f4654] leading-relaxed">
          ...
          <Link href="/glossary#cpr-part-35" className="text-[#0284c7] hover:underline">
            CPR Part 35
          </Link>
        ...
        <h2 id="cpr-part-35" className="mt-10 scroll-mt-24 text-xl font-bold text-[#18181b]">
          ...
          <table className="w-full min-w-[640px] border-collapse text-left text-sm">
            ...
            <thead>
              <tr className="border-b border-[#e2e8f0] bg-[#f4f6f8]">
                <th className="p-3 font-semibold text-[#18181b]">Principle</th>
                <th className="p-3 font-semibold text-[#18181b]">Requirement</th>
                <th className="p-3 font-semibold text-[#18181b]">2025–2026 Application</th>
              </tr>
            </thead>
            <tbody>
              {frameworkTable.map((row) => (
                <tr key={row.principle} className="border-b border-[#e2e8f0]">
                  <td className="p-3 text-[#3f4654]">{row.principle}</td>
                  <td className="p-3 text-[#3f4654]">{row.requirement}</td>
                  <td className="p-3 text-[#3f4654]">{row.application}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 id="practice-direction-2024" className="mt-10 scroll-mt-24 text-xl font-bold text-[#18181b]">
        ...
        <h2 id="adam-pipe-2025" className="mt-10 scroll-mt-24 text-xl font-bold text-[#18181b]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#18181b]">Expert Witness vs Advocate</h2>
        <p className="mt-4 text-[#3f4654] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#18181b]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#18181b]">Oral Evidence at Tribunal</h2>
        <p className="mt-4 text-[#3f4654] leading-relaxed">
          ...
          essential. See our{" "}
          <Link href="/oral-evidence" className="text-[#0284c7] hover:underline">
            oral evidence guide
          </Link>{" "}
          for comprehensive hearing procedure and preparation standards.
        </p>

        <h2 className="mt-10 text-xl font-bold text-[#18181b]">Legal Aid Expert Witness Instruction</h2>
        <p className="mt-4 text-[#3f4654] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#18181b]">Network of Specialist Witnesses</h2>
        <p className="mt-4 text-[#3f4654] leading-relaxed">
          Country-specific and thematic expert witnesses across the network — see the{" "}
          <Link href="/network" className="text-[#0284c7] hover:underline">
            network directory
          </Link>{" "}
