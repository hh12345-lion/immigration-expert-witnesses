  ...
  return (
    <>
      ...
      >
        ...
        <h2 id="ikarian-reefer" className="mt-10 scroll-mt-24 text-xl font-bold text-[#121614]">
        ...
        <p className="mt-4 text-[#3d443f] leading-relaxed">
          ...
          <Link href="/glossary#cpr-part-35" className="text-[#3a5244] hover:underline">
            CPR Part 35
          </Link>
        ...
        <h2 id="cpr-part-35" className="mt-10 scroll-mt-24 text-xl font-bold text-[#121614]">
          ...
          <table className="w-full min-w-[640px] border-collapse text-left text-sm">
            ...
            <thead>
              <tr className="border-b border-[#c3c7c0] bg-[#e6e8e4]">
                <th className="p-3 font-semibold text-[#121614]">Principle</th>
                <th className="p-3 font-semibold text-[#121614]">Requirement</th>
                <th className="p-3 font-semibold text-[#121614]">2025–2026 Application</th>
              </tr>
            </thead>
            <tbody>
              {frameworkTable.map((row) => (
                <tr key={row.principle} className="border-b border-[#c3c7c0]">
                  <td className="p-3 text-[#3d443f]">{row.principle}</td>
                  <td className="p-3 text-[#3d443f]">{row.requirement}</td>
                  <td className="p-3 text-[#3d443f]">{row.application}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 id="practice-direction-2024" className="mt-10 scroll-mt-24 text-xl font-bold text-[#121614]">
        ...
        <h2 id="adam-pipe-2025" className="mt-10 scroll-mt-24 text-xl font-bold text-[#121614]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#121614]">Expert Witness vs Advocate</h2>
        <p className="mt-4 text-[#3d443f] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#121614]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#121614]">Oral Evidence at Tribunal</h2>
        <p className="mt-4 text-[#3d443f] leading-relaxed">
          ...
          essential. See our{" "}
          <Link href="/oral-evidence" className="text-[#3a5244] hover:underline">
            oral evidence guide
          </Link>{" "}
          for comprehensive hearing procedure and preparation standards.
        </p>

        <h2 className="mt-10 text-xl font-bold text-[#121614]">Legal Aid Expert Witness Instruction</h2>
        <p className="mt-4 text-[#3d443f] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#121614]">Network of Specialist Witnesses</h2>
        <p className="mt-4 text-[#3d443f] leading-relaxed">
