  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-8 text-xl font-bold text-[#121614]">Legal Aid Cases</h2>
        <p className="mt-4 text-[#3d443f] leading-relaxed">
          ...
          and{" "}
          <Link href="/tribunal-evidence/legal-aid-expert-witness-rates" className="text-[#3a5244] hover:underline">
            LAA rates guide
          </Link>
          .
        </p>

        <h2 className="mt-8 text-xl font-bold text-[#121614]">Private Instruction</h2>
        <p className="mt-4 text-[#3d443f] leading-relaxed">
