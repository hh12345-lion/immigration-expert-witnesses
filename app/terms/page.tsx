...
export default function TermsPage() {
  ...
  return (
    <PageShell title="Terms of Use" breadcrumbs={crumbs}>
      ...
      <h2 className="mt-8 text-lg font-bold text-[#121614]">Not legal advice</h2>
      ...
      <h2 className="mt-8 text-lg font-bold text-[#121614]">Instruction process</h2>
      <p className="mt-4 text-[#3d443f] leading-relaxed">
      ...
      <h2 className="mt-8 text-lg font-bold text-[#121614]">Network sites</h2>
      <p className="mt-4 text-[#3d443f] leading-relaxed">
      ...
      <h2 className="mt-8 text-lg font-bold text-[#121614]">Limitation of liability</h2>
      <p className="mt-4 text-[#3d443f] leading-relaxed">
