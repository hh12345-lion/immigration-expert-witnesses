  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2744]">FTT Hearing Procedure Checklist</h2>
          ...
          <table className="w-full min-w-[560px] border-collapse text-left text-sm">
            ...
            <thead>
              <tr className="border-b border-[#C5D0DC] bg-[#F3F6F9]">
                <th className="p-3 font-semibold text-[#1A2744]">Stage</th>
                <th className="p-3 font-semibold text-[#1A2744]">Solicitor / expert action</th>
              </tr>
            </thead>
            <tbody>
              {hearingSteps.map((row) => (
                <tr key={row.step} className="border-b border-[#C5D0DC]">
                  <td className="p-3 font-medium text-[#1A2744]">{row.step}</td>
                  <td className="p-3 text-[#374151]">{row.action}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2744]">When Oral Evidence Is Directed</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2744]">Preparation for Oral Evidence</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2744]">Hearing Procedure</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2744]">Cross-Examination</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <p className="mt-4 text-[#374151] leading-relaxed">
          See our{" "}
          <Link href="/tribunal-evidence/cross-examination-preparation" className="text-[#1A6B78] hover:underline">
            cross-examination preparation guide
          </Link>{" "}
          for detailed preparation standards.
        </p>

        <h2 className="mt-10 text-xl font-bold text-[#1A2744]">Joint Expert Meetings</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <p className="mt-4 text-[#374151] leading-relaxed">
          ...
          <Link href="/tribunal-evidence/joint-statement-meetings" className="text-[#1A6B78] hover:underline">
            joint expert meetings guide
          </Link>
          .
        </p>

        <h2 className="mt-10 text-xl font-bold text-[#1A2744]">Post-Hearing Supplementary Reports</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          ...
          <Link href="/witness-types/oral-evidence-witness" className="font-semibold text-[#1A6B78] hover:underline">
          ...
          <Link href="/tribunal-evidence/oral-evidence-hearing" className="font-semibold text-[#1A6B78] hover:underline">
            Oral evidence at hearing
          </Link>
          <a href={SISTER_HUB_URL} target="_blank" rel="noopener noreferrer" className="font-semibold text-[#B8943E] hover:underline">
