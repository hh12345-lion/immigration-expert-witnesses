...
export const networkSites: NetworkSite[] = [
  {
    ...
    description:
      "Clan analysis, Al-Shabaab risk, MOJ Country Guidance framework, FGM, and Mogadishu return viability — specialist Somalia expert witnesses for UK asylum appeals.",
    anchorText: "Somalia expert witnesses for UK immigration tribunals",
    category: "country",
  },
  {
    name: "Nigeria Expert",
    ...
    anchorText: "Nigeria expert witnesses for UK asylum and deportation cases",
    category: "country",
  },
  {
    ...
    role: "Country witness site",
    description:
      "Ahmadi, blasphemy, honour killing, and FGM risk analysis — Pakistan country expert witnesses for UK immigration tribunal proceedings.",
    anchorText: "Pakistan country expert witnesses for UK tribunals",
    category: "country",
  },
  {
    ...
    anchorText: "Africa expert witnesses for UK immigration appeals",
    category: "country",
  },
  {
    ...
    role: "Country witness site",
    description:
      "Blood feuds, trafficking, LGBT, and Kanun customary law — Albania expert witnesses for UK asylum and human rights proceedings.",
    anchorText: "Albania expert witnesses for UK immigration tribunals",
    category: "country",
  },
  {
    ...
    role: "Country witness site",
    description:
      "India, Sri Lanka, Bangladesh, Nepal, and caste-related risk analysis — South Asia expert witnesses for UK tribunal proceedings.",
    anchorText: "South Asia expert witnesses for UK asylum appeals",
    category: "country",
  },
  {
    ...
    role: "Country witness site",
    description:
      "Taliban-era risk, Hazara ethnicity, women's rights, and DD Country Guidance framework — Afghanistan expert witnesses for UK appeals.",
    anchorText: "Afghanistan country expert witnesses for UK tribunals",
    category: "country",
  },
  {
    ...
    anchorText: "Persecution expert witnesses for UK asylum appeals",
    category: "thematic",
  },
  {
    ...
    anchorText: "Human rights expert witnesses for UK immigration tribunals",
    category: "thematic",
  },
  {
